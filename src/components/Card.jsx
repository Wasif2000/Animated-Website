    ...
    <>
      <div className='flex'>
        <div className='w-[50%] px-[70px] py-10'>
          ...
          <button className='flex gap-2 mt-3 ml-1 border border-black px-4 py-2 rounded-[15px] hover:bg-black hover:text-white'>
            Read More
            <div className='text-[25px]'><VscArrowCircleUp /></div>
          </button>
        </div>
        <div className='w-[50%]'>
